    ...
    struct Mesh
    {
        ...
        std::vector<Vect3> get_positions(){
            ...
            for(Vertex v: Vertices){
                positions.push_back(Vect3(v.Position.X,v.Position.Y,v.Position.Z));
            }
            return positions;
        }
        
        std::vector<Vect3> get_normals(){
            std::vector<Vect3> normals;
            for(Vertex v: Vertices){
                normals.push_back(Vect3(v.Normal.X,v.Normal.Y,v.Normal.Z));
            }
            return normals;
        }
        
        std::vector<Vect2> get_uvs(){
            std::vector<Vect2> uvs;
            for(Vertex v: Vertices){
                uvs.push_back(Vect2(v.TextureCoordinate.X,v.TextureCoordinate.Y));
            }
            return uvs;
        }
